...
This directory defines the **v1 structure** of the Visa credential, including its profiles, input definitions, and supporting resources.  
...
For more information on the Visa credential type and its structure, see: 
[Visa specification](TODO).
-->