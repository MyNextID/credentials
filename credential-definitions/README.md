...
This section provides an overview of the credential types available in this repository. Each credential type is maintained in its own directory and includes the relevant schemas, examples, and supporting resources.

Use the table below to see which credential profiles support each type. For complete details, including version-specific schemas and examples, select a credential type or browse the corresponding directory.
...
### [Age Verification Credential](/credential-definitions/age-verification)
...
- **EUDI AV**: [Schema](/credential-definitions/age-verification/v1/eudi.av/mdoc/schema.json)
...
- **ISO-18013-5**: [Schema](/credential-definitions/mobile-driving-licence/v1/iso-18013-5/mdoc/schema.json)

### [Person Identification Data](/credential-definitions/personal-id)
...
- **EUDI PID**: [Schema](/credential-definitions/personal-id/v2/eudi.pid/mdoc/schema.json)
...
- **EDC**: [Schema](/credential-definitions/student-id/v1/edc/w3c-vc/schema.json)