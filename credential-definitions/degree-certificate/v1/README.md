# Degree Certificate (v1)

This directory defines the **v1 structure** of the Degree Certificate credential, including its profiles, input definitions, and supporting resources.
