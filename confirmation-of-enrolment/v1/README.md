# Confirmation of Enrolment (v1)

This directory defines the **v1 structure** of the Confirmation of Enrolment credential, including its profiles, input definitions, and supporting resources.
