...
Each credential type must be placed in its own folder inside the `credential-definitions/` directory and follow the structure shown below. This ensures that all credentials can be validated, generated, and translated consistently across the system.
