...
The file is located in the `.autogen` directory and is automatically updated whenever new credential types are merged or existing ones are versioned or extended (e.g., adding new translations). It is accessible via the following link:

- [credentials.json](../.autogen/credentials.json)
...
- [credential-types.json](../.autogen/credential-types.json)
