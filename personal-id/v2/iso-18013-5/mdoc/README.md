...
- [eu.europa.ec.eudi.pid.1-schema-schema](eu.europa.ec.eudi.pid.1-schema-schema.json) - JSON Schema defintion for the mDoc namespace `eu.europa.ec.eudi.pid.1-schema`, as defined in `schema.json`
