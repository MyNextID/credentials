...
This directory provides the repository’s implementation of the European Digital Credentials (EDC) profile for Student ID, serving as a container for supported data models based on the ELM ontology, with links to their implementations.
