...
- [translations](translations) - Localization files for Certificate of Attendance input fields.
...
- [input-fields-to-credential-map](input-fields-to-credential-map.json) - Mapping between user-friendly input fields and the ELM Certificate of Attendance fields. 
